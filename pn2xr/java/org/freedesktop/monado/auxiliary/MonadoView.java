...
public class MonadoView extends SurfaceView
     ...
     */
    public static MonadoView attachToActivity(final Activity activity) {
     ...
     */
    public static void removeFromWindow(MonadoView view) {
        Handler handler = new Handler(Looper.getMainLooper());
        handler.post(
                () -> {
    ...
    public static int getDisplayModeIdWidth(
            final Context context, int display, int displayModeId) {
     ...
     */
    public SurfaceHolder waitGetSurfaceHolder(int wait_ms) {
