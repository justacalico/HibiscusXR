...
APPS=/mnt/f/PN2Lineage/pvr_apps_final
APPLIBS=/mnt/f/PN2Lineage/pvr_applibs
OEM=/mnt/f/PN2Lineage/oem_final
STACK=/mnt/f/PN2Lineage/pvr_stack
LOG=/mnt/f/PN2Lineage/notes/144_stage.txt
exec >"$LOG" 2>&1
