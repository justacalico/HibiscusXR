...
LOG=${PN2_ROOT}/notes/373_img_fan.txt
exec >"$LOG" 2>&1
...
echo
echo "=== fan daemon ==="
put ${PN2_ROOT}/fan/fancontrol /bin/fancontrol 755
put ${PN2_ROOT}/overlay/etc/init/pn2-fanservice.rc /etc/init/pn2-fanservice.rc 644
