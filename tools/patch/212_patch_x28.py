...
SRC = sys.argv[1] if len(sys.argv) > 1 else PN2_ROOT + "/notes/vrshell_lib/libPvr_UnitySDK.so"
DST = sys.argv[2] if len(sys.argv) > 2 else PN2_ROOT + "/notes/vrshell_lib/libPvr_UnitySDK.patched.so"
